      ...
      ______node_modules_marko_layout_use_tag_js,
      {
        ...
        "getContent": function(__layoutHelper) {
          ...
          __tag(out,
            ...
            function(out) {
              out.w('<div id="login" class="container"><form id="loginForm" method="post" name="userInfo" action="/authenticate"><input type="text" name="username" label="User Name" placeholder="Enter your username"><input type="password" name="password" label="Password" placeholder="Your password"><input type="submit" value="Login"></form></div>');
            });
