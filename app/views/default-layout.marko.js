function create(__helpers) {
  ...
  return function render(data, out) {
    ...
    __tag(out,
      ...
      function(out) {
        out.w('<nav class="footer nav"><div class="container-fluid"><ul class="nav"><li><a href="#">Github</a></li><li><a href="#">Twitter</a></li><li><a href="#">Facebook</a></li><li><a href="#">Youtube</a></li></ul></div></nav> ');
      });
